...
class CharacterDetailsScreen extends StatelessWidget {
  ...
  CharacterDetailsScreen({required this.characterModel});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildDivider(315),
                    characterInfo(
                        'Appeared in : ', characterModel.categoryForTwoSeries!),
                    buildDivider(250),
                    characterInfo('Seasons : ',
                        characterModel.appearanceOfSeason!.join(' / ')),
                    buildDivider(280),
                    characterInfo(
                        'Status : ', characterModel.statusIfDeadOrAlive!),
                    buildDivider(300),
                    if (characterModel.betterCallSaulAppearance!.isNotEmpty)
                      characterInfo('Better Call Saul Seasons : ',
                          characterModel.betterCallSaulAppearance!.join(" / ")),
                    if (characterModel.betterCallSaulAppearance!.isNotEmpty)
                      buildDivider(150),
                    characterInfo(
